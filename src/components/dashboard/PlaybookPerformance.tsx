      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-black tracking-[0.2em] text-slate-900 dark:text-white uppercase">Performance Follow Playbook</h2>
          </div>
          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Tracking discipline-only performance</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="h-full">
            <div className="flex items-center gap-2 border-b border-slate-50 dark:border-slate-800 pb-4 mb-6">
              ...
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Overall Performance</h3>
            </div>
            <QuickStat 
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 border-b border-slate-50 dark:border-slate-800 pb-4">
              ...
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Winrate by Pair</h3>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 border-b border-slate-50 dark:border-slate-800 pb-4">
              <TrendingUp className="w-4 h-4 text-slate-400" />
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Winrate by Setup</h3>
            </div>
        ...
        <div className="pt-10 border-t border-slate-50 dark:border-slate-800">
          <div className="space-y-6 max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-2 pb-4">
              ...
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Trade Distribution</h3>
            </div>
...
function QuickStat({ label, value, subValue, color, icon }: { label: string; value: string | number; subValue: string; color?: string; icon: React.ReactNode }) {
  return (
    <div className="p-5 bg-slate-50/50 dark:bg-slate-800/30 rounded-2xl border border-slate-100 dark:border-slate-800/50">
      ...
      <h4 className={`text-xl font-black mb-1 ${color || "text-slate-900 dark:text-white"}`}>{value}</h4>
...
function EmptyState() {
  return (
    <div className="h-[200px] flex items-center justify-center border-2 border-dashed border-slate-50 dark:border-slate-800 rounded-[24px]">
      <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest italic">No data for this period</p>
    </div>
  );
}
